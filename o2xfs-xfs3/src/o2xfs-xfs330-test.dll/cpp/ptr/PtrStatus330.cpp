#include "ptr/at_o2xfs_xfs_v3_30_ptr_PtrStatus330Test.h"
...
JNIEXPORT jobject JNICALL Java_at_o2xfs_xfs_v3_130_ptr_PtrStatus330Test_buildPtrStatus330(JNIEnv *env, jobject obj) {
	...
	Status.wPaperType[WFS_PTR_SUPPLYUPPER] = WFS_PTR_PAPERSINGLESIDED;
	Status.wPaperType[WFS_PTR_SUPPLYLOWER] = WFS_PTR_PAPERDUALSIDED;
	Status.wAntiFraudModule = WFS_PTR_AFMOK;
	Status.wBlackMarkMode = WFS_PTR_BLACKMARKDETECTIONON;
