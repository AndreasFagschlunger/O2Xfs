#include "ptr/at_o2xfs_xfs_v3_30_ptr_PtrCapabilities330Test.h"
...
static DWORD dwSynchronizableCommands[] = { WFS_CMD_PTR_READ_IMAGE, WFS_CMD_PTR_PRINT_FORM, 0 };

JNIEXPORT jobject JNICALL Java_at_o2xfs_xfs_v3_130_ptr_PtrCapabilities330Test_buildPtrCapabilities330(JNIEnv *env, jobject obj) {
	...
	Caps.dwControlEx = WFS_PTR_CTRLCUT | WFS_PTR_CTRLEJECT;
	Caps.bBlackMarkModeSupported = TRUE;
